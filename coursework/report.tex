...
%% 信息
\title{西安交通大学课程作业\LaTeX 模板——标题}
\author{高旭帆\\ \xiaowu （西安交通大学生命学院，化生试验班，西安\hspace{0.5em}710049）}  %高旭帆\\ \xiaowu （西安交通大学生命学院，化生试验班，西安\hspace{0.5em}710049）
\stuId{2186113574}
\class{化生81}
\school{生命学院}
\course{马克思主义基本原理}
...
\begin{document}
%% 设置标题
\input{./template/titlepage.tex}%标题，单独页
\input{./template/abstract.tex}%摘要	
%\input{./template/normaltitle.tex}%正常标题
