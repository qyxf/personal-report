...
%set BSTINPUTS=C:/temp;

% 由于是课程作业，所以封面、信息等不提供英文版本，如有需要请自行修改settings.tex文件
%% 设置
...
\usepackage[round,authoryear]{natbib} % only when using .bibs
\newcommand{\tabincell}[2]{\begin{tabular}{@{}#1@{}}#2\end{tabular}}

\usepackage{algorithm}
\usepackage{algorithmic}

%\setlength{\parindent}{0em} % 英文不缩进
\setlength{\parindent}{2em}

%% 信息
\title{西安交通大学课程作业\LaTeX 模板} % 也可以标题为课程名，副标题为小作业名
%\title{Theoretical Methods to Study Protein Structures} % 英文标题
...
\pageheader{这是页眉}%暂时的页眉，还没完善

%\title{智能决策与机器学习}
%\author{王皓轩}  %高旭帆\\ \xiaowu （西安交通大学生命学院，化生试验班，西安\hspace{0.5em}710049）
%\stuId{2186113904}
%\class{大数据81}
%\school{管理学院}
%\course{马克思主义基本原理}
%\subtitle{Revised Decision Tree}
...
%\input{./template/titlepage.tex} % 单独页标题
\input{./template/normaltitle.tex} % 正常标题，不允许也不应有双栏
% 双栏版，可能要调列表行距
...
\begin{figure}[!h]
	\centering
	\includegraphics[width=\linewidth]{city}
	\caption{城市风光}
	\label{fig:2333}
\end{figure}
...
%			\includegraphics[width=\textwidth]{remde}
%	\end{minipage}}
%	\quad
%	\subfigure[]{
%		\begin{minipage}[t]{0.3\linewidth}
%			\includegraphics[width=\textwidth]{remde-act}
%	\end{minipage}}
%	\quad
%	\subfigure[]{
%		\begin{minipage}[t]{0.3\linewidth}
%			\includegraphics[width=\textwidth]{atp}
%	\end{minipage}}
%	\caption{ATP}
%\end{figure}

% also recommend subfloat package
%\begin{figure}[htbp]
%	\centering
%	\captionsetup[subfloat]{format=hang,singlelinecheck=false, justification=centering,font={stretch=1.3}}
%	\subfloat[ATP]{
%		\begin{minipage}[t]{0.3\linewidth}
%			\includegraphics[width=\textwidth]{atp}
%	\end{minipage}}
%	\quad
%	\subfloat[ponatinib \protect\\ \scriptsize(ID:DB08901)]{
%		\begin{minipage}[t]{0.3\linewidth}
%			\includegraphics[width=\textwidth]{ponatinib}
%	\end{minipage}}
%\end{figure}
